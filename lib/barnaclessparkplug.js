...
class BarnaclesSparkplug {
  ...
  constructor(options) {
    ...
    this.client = createSparkplugClient(this, options.clientOptions);
  }
 ...
 * @param {BarnaclesSparkplug} instance The BarnaclesSparkplug instance.
 * @param {Object} clientOptions The Sparkplug/MQTT client options.
 */
function createSparkplugClient(instance, clientOptions) {
  clientOptions = clientOptions || {};
  let config = {
      serverUrl: clientOptions.url || DEFAULT_URL,
      username: clientOptions.username || null,
      password: clientOptions.password || null,
      groupId: clientOptions.groupId || DEFAULT_GROUP_ID,
      edgeNode: clientOptions.edgeNodeId || DEFAULT_EDGE_NODE_ID,
      clientId: clientOptions.clientId || DEFAULT_CLIENT_ID,
      version: "spBv1.0"
  };
